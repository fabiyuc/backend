...
public class TipoLicenciaService {
    ...
    public Optional<TipoLicencia> getById(Long id) {
        return tipoLicenciaRepository.findById((Long) id);
    }
    ...
    public Optional<TipoLicencia> getByLey(String ley) {
        return tipoLicenciaRepository.findByLey(ley);
    }
    ...
    public boolean existsByLey(String ley) {
        return tipoLicenciaRepository.existsByLey(ley);
    }
