...
public interface HabilitacionesGuardiasRepository extends JpaRepository<HabilitacionesGuardia, Long> {
  ...
  List<HabilitacionesGuardia> findHabilitacionesGuardiasByEfectorAndAsistencial(
  ...
  @Query("""
      ...
      """)
  List<Asistencial> findAsistencialesWithCfAndExtraByEfector(@Param("idEfector") Long idEfector);
