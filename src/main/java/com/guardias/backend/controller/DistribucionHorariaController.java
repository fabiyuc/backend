...
public class DistribucionHorariaController {
    ...
    // public ResponseEntity<List<DistribucionHoraria>>
    // getByEfector(@PathVariable("idEfector") Long idEfector) {
    ...
    // distribucionHorariaService.findByEfectorId(idEfector).get();
     ...
     * HttpStatus.NOT_FOUND);
     * List<DistribucionHoraria> distribucionHoraria =
     * distribucionHorariaService.findByPersonaId(idPersona).get();
     * return new ResponseEntity<>(distribucionHoraria, HttpStatus.OK);
     * }
     * 
     * @PostMapping("/create")
     * public ResponseEntity<?> create(@RequestBody DistribucionHorariaDto
     * distribucionHorariaDto) {
     * 
     * if (distribucionHorariaDto.getCantidadHoras() == null)
     * return new ResponseEntity(new Mensaje("la cantidad es obligatoria"),
     * HttpStatus.BAD_REQUEST);
     * 
     * DistribucionHoraria distribucionHoraria = new DistribucionHoraria(); // CLASE
     * ABSTRACTA!!!!!
     ...
     * distribucionHorariaService.findById(id).get();
     * 
