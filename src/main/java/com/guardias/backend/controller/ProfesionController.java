...
public class ProfesionController {
     ...
     * ProfesionDto profesionDto) {
     * if (!profesionService.existsById(id))
     * return new ResponseEntity(new Mensaje("no existe la profesion"),
     * HttpStatus.NOT_FOUND);
     * 
     * if (profesionService.existsByNombre(profesionDto.getNombre()) &&
     * profesionService.getByNombre(profesionDto.getNombre()).get().getId() == id)
     * return new ResponseEntity(new Mensaje("esa profesion ya existe"),
     * HttpStatus.BAD_REQUEST);
     * 
     * if (StringUtils.isBlank(profesionDto.getNombre()))
     * return new ResponseEntity(new Mensaje("la profesion es obligatoria"),
     * HttpStatus.BAD_REQUEST);
     * 
     ...
     * profesionService.save(profesion);
     * return new ResponseEntity(new Mensaje("Profesion actualizada"),
     * HttpStatus.OK);
     * }
     */
