...
/* ############  validar campos en front o ver como hacerlo aqui con bool y date */
        ...
        Autoridad autoridad = new Autoridad(autoridadDto.getNombre(),
            autoridadDto.getFechaInicio(),
                autoridadDto.getFechaFinal(), 
                autoridadDto.isEsActual(),
                autoridadDto.isEsRegional());
